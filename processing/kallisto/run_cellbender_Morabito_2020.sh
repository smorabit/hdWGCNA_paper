...
cd /dfs3b/swaruplab/shared_lab/cross-disorder/count_matrices/Morabito_2020/
...
do
    ...
    settings=$(head -n $index /dfs3b/swaruplab/shared_lab/cross-disorder/bin/Morabito_2020/cellbender_settings.csv | tail -n 1)
