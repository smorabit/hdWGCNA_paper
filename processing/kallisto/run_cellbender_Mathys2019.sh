...
do
    ...
    # get the current xfile to download from the filepaths txt file:
    settings=$(head -n $index /dfs3b/swaruplab/shared_lab/cross-disorder/bin/Mathys_2019/cellbender_settings.csv | tail -n 1)
